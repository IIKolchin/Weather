...
const getWeather = (e) => {
    e.preventDefault()
    getCoord(weatherInput.value)
    .then((data) => {
        getWeatherRequest(data[0].lat, data[0].lon)
        .then((data) => {
        ...
        iframe.setAttribute('src', `https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d576587.6582438038!2d${lon}!3d${lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2sru!4v1652100284601!5m2!1sru!2sru`)
    })
...
const createForecast = (element) => {
    ...
    main.textContent = element.weather
